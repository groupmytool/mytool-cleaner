...
public class AppConfigParser {
  ...
  public static HashMap<String, ArrayList<AppConfig>> appConfMap = new HashMap<>();
      ...
      Files.list(Paths.get(confDirUrl.toURI()))
          ...
          .forEach(file -> {
            try (Reader reader = Files.newBufferedReader(file)) {
              ...
              Type type = new TypeToken<ArrayList<AppConfig>>() {}.getType();
              ArrayList<AppConfig> configArrayList = gson.fromJson(reader, type);
